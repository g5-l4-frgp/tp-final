...
%>
    <tr class="text-light">
      ...
      <td><%=e.getCuotasPagas()%><input type="hidden" name="idCuenta" value="<%=e.getCuenta().getID()%>"></td>
      <td><%=e.getCantidadCuotas()%></td><input type="hidden" name="idPrestamo" value="<%=e.getIdPrestamo()%>"></td>

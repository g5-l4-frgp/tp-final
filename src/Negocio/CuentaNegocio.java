...
public class CuentaNegocio implements Interface_Cuenta {
	...
	@Override
	public Cuentas BuscarCuentasXnumero(String numero) {
		// TODO Auto-generated method stub
		return cuentaDAO.BuscarCuentasXnumero(numero);
	}
	@Override
	public Cuentas BuscarCuentasXCBU(String cbu) {
		// TODO Auto-generated method stub
		return cuentaDAO.BuscarCuentasXCBU(cbu);
	}
